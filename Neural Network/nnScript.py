...
def nnObjFunction(params, *args):
    ...
    obj_val = 0
    #print("print w1 = ",w1.shape)
    #print("print w2 = ", w2.shape)
    # Your code here
    x = training_data
    #print("x = ",x.shape)
    ...
    #print("now x = ", x.shape)
    w1 = w1.transpose()
    #print("w1 after transpose = ", w1.shape)
    aj = np.dot(x,w1);
    #print ("aj = ",aj.shape)
    zj = sigmoid(aj);
    #print("zj = ",zj.shape);
    ...
    #print("now zj = ", zj.shape)
    w2 = w2.transpose()
    #print("w2 after transpose = ", w2.shape)
    bl = np.dot(zj, w2);
    #print("bl = ", bl.shape)
    ol = sigmoid(bl);
    #print("ol = ", ol.shape);
    ...
    #print("deltaltrp = ", deltaltrp.shape)

    dw2lj = np.dot(deltaltrp, zj)
    #print("dw2lj = ",dw2lj.shape)
    ...
    #print("tempvar = ",tempvar.shape)
    tempvar = np.delete(tempvar, len(tempvar) - 1, 0)
    #print("now tempvar = ", tempvar.shape)
...
def nnPredict(w1, w2, data):
    ...
    #print("w1 = in predict", w1.shape)
    #print("w2 = in predict", w2.shape)
    #print("data = in predict", data.shape)
